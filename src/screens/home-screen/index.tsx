...
export default function HomeScreen() {
  ...
  const handleLogout = async () => {
    try {
      ...
      dispatch(logout());
      Alert.alert('Success', 'Logged out and token removed from secure storage!');
    } catch (error) {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statCard}>
            <Ionicons name={isAuthenticated ? "shield-checkmark" : "shield"} size={24} color={isAuthenticated ? "#45B7D1" : "#gray"} />
          ...
          {isAuthenticated && (
            <>
              ...
              >
                ...
                <Text style={[styles.buttonText, { color: "#007AFF" }]}>Show Token Info</Text>
              </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.featureText}>
            ...
            • Redux cart with persistent state{'\n'}
